...
define('ADMIN_USER','kcoolman');
define('ADMIN_PASS','poundit!2014');
...
$startOffline = '1';			// Load bar in offline mode for all first time users?
...
$desktopNotifications = '0';			// If yes, Google desktop notifications will be enabled for Google Chrome
