<?php
/*
 Plugin Name: Buddypress *Custom Social Articles
 Description: This plugin has been modified by Pound. DO NOT UPDATE. This is the first BuddyPress plugin that let you to create and manage posts from your profile. It supports all buddypres themes, so you don't need to be an expert to use it!
 Version: 1000.00
 Author: Broobe
...
if (!class_exists('SocialArticles') && is_plugin_active( 'buddypress/bp-loader.php' )) {
    ...
    class SocialArticles extends Broobe_SA_Plugin_Admin {
        ...
        public function loadScripts() { 
			...
			//Cued these files in modules/scripts/load.min.js in 'toasted' template for performance @pound
...
//		   Loaded Stylesheet Manually in Theme @pound
