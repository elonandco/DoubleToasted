...
function create_post(){
    article_manager("create", $_POST['post_id'], $_POST['post_title'], $_POST['post_content'], $_POST['category_id'], $_POST['tag_names'],  $_POST['status'], $_POST['post_image'], $_POST['user_id']);
} 

add_action('wp_ajax_nopriv_update_post', 'update_post' );
add_action('wp_ajax_update_post', 'update_post' );  
function update_post(){
    article_manager("update", $_POST['post_id'], $_POST['post_title'], $_POST['post_content'], $_POST['category_id'], $_POST['tag_names'],  $_POST['status'], $_POST['post_image'], $_POST['user_id']);
}
...
function delete_article(){
    ...
    if( $_POST['user_id'] == $postToDelete->post_author && ($socialArticles->options['allow_author_deletion']=="true" || $postToDelete->post_status=="draft") ){
...
function article_manager($task, $postId, $post_title, $post_content, $post_category, $post_tags, $post_status, $post_image, $user_id ){
    global $bp;
    ...
    if($post_title == ""){
        ...
        $my_post['post_type'] = 'dt-users-blog'; 
                ...
                <div class="article-content">
                    ...
                    <?php if(bp_displayed_user_id()==bp_loggedin_user_id()):?>
                          <div class="author-options">
                            ...
                            <?php endif;?>
                            <?php if($socialArticles->options['allow_author_deletion']=="true" || $post->post_status=="draft"): global $current_user; ?>
                            <a class="delete" title="<?php _e("delete article", "social-articles" );?>" id="delete-<?php echo $post->ID; ?>" href="#" onclick="deleteArticle(<?php echo $post->ID; ?>, <?php echo $current_user->ID; ?>); return false;"></a>        
                            <?php endif;?>
                          </div>
                    <?php endif;?>              
