...
<section id="articles-container">     
    ...
    <h3>Blog Posts</h3>
    <div class="item-list-tabs no-ajax usr-articles-subn fl-left">                          
        <ul class="nav nav-tabs listless">                    
            <li id="publish-tab" class="current fl-left">
            ...
            <li id="pending-tab" class=" fl-left">
    ...
    <div id="message" class="messageBox note icon">
        <h3><?php _e("No articles written yet.", "social-articles");?></h3>
    </div>
    <?php endif;?>    
</section>     
