...
class BP_Editable_Activity_Helper{
    ...
    public function load_js(){
        ...
        if( $this->should_load_assets() ){
            wp_register_script( 'jquery-editable', $this->plugin_url . 'assets/jqe/jqueryui-editable/js/jqueryui-editable.js', array( 'jquery', 'jquery-ui-tooltip','jquery-ui-button' ) );
