...
<!--Support Old WP Comments - located at end of blogactivity-comments.php -->
	...
	<?php if ( have_comments() ) : ?>
		...
		<div id="comments">
			...
			<ol class="commentlist">
				<?php wp_list_comments( array( 'callback' => 'bp_activity_blog_comments_dtheme_blog_comments' ) ); ?>
			</ol><!-- .comment-list -->
	...
	<?php else : ?>
		...
		<?php if ( pings_open() && !comments_open() && is_single() ) : ?>
			...
			<p class="comments-closed pings-open">
				<?php printf( __('<a href="%1$s" title="Trackback URL for this post">trackbacks</a> and pingbacks are open.', 'bp-activity-blog-comments'), trackback_url( '0' ) ); ?>
			</p>
