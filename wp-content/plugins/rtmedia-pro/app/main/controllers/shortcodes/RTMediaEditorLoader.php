                    ...
                    <div class="uploader-container" id="uploader_container" style="display: none">
						...
						if( $value['name'] == "playlist" ) {
                            ...
                            <p>
                                ...
                                <span><input type='radio' name="redirect" value='true' id="redirect_true" onclick="change_redirect(this.value)" ><label for='redirect_true'>True</label></span>
                                <span><input type='radio' name="redirect" value='false' checked='checked' id="redirect_false" onclick="change_redirect(this.value)"><label for='redirect_false'>false</label></span>
                            </p>
