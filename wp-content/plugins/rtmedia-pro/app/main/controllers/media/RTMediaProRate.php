            ...
            <div class="rtmedia-pro-rates">
                <label class="rtmedia-pro-average-rating" >
                    ...
                    <span class='rtmedia-avg-rate'>
                        <?php echo __('Rating : ', 'rtmedia'); ?><span id="rtmedia_pro_media_average_rating"><?php echo ($curr_avg>0)?__(round($curr_avg,1)):__('NA', 'rtmedia'); ?></span>
                    </span>
                    <span class='rtmedia-user-rate'>
                        <?php echo __('Your Rating : ', 'rtmedia'); ?><span id="rtmedia_pro_media_user_rating"><?php echo ($default_rating>0)?__($default_rating):__('NA', 'rtmedia'); ?></span></span>
                    )
                </label>
            </div>
