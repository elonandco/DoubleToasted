        ...
        if( isset( $media_type ) && $media_type == "playlist") {
            ...
            if( $media_list != "") {
                ...
                $media_table = "<div class='rtmedia-playlist-media-table'>"
                        ...
                        . "<thead><tr><th>" . __('Title', 'rtmedia') . "</th><th colspan='2'>" . __('Actions', 'rtmedia') . "</th></tr></thead>"
                        . "<tbody>";
                foreach( $media_list as $media_id) {
                   ...
                   if($media) {
                       ...
                       $list .= "<tr>"
                               	. "<td class='rtm-edit-media-list-title'><a href='". $link ."' target='_blank' title='" . __('View this media', 'rtmedia') . "' ><i class='rtmicon-music rtmicon-fw'></i> " . $media[0]->media_title . "</a></td>"
                               	. "<td class='rtm-edit-media-list-edit'><a href='". $link ."/edit' target='_blank' title='" . __('Edit this media', 'rtmedia') . "' ><i class='rtmicon-edit rtmicon-fw'></i>" . __('Edit', 'rtmedia') . "</a></td>"
					   			. "<td class='rtm-edit-media-list-delete'><span id='" . $media[0]->id . "' class='rtmedia-remove-media-from-playlist' title='" . __('Remove media from this playlist', 'rtmedia') . "' ><i class='rtmicon-times-circle rtmicon-fw' ></i>" . __( 'Remove', 'rtmedia' ). "</span></td>"
                               	. "</tr>";
                   }
    ...
    function rtmedia_single_playlist_content ( $html, $rtmedia_media ) {
        ...
        if( is_rtmedia_playlist () ) {
            ...
            if( $source != "") {
                ...
                $html = "<span>" . __('Oops. No media found for this playlist.', 'rtmedia') . "</span>";
                return $html;
            }
