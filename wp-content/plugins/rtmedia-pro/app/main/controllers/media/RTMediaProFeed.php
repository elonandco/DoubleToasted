...
//	add_filter("rtmedia_pro_settings_tabs_content", array($this,"rtmedia_pro_add_feed_tab"), 40, 1);
	...
	<div class="postbox metabox-holder">
	    <h3 class="hndle"><span><?php _e( 'Podcasting and RSS Feed', 'rtmedia'); ?></span></h3>
	<?php
    ...
    function rtmedia_add_rss_feed($options) {
		$options[] = '<a id="rtmedia-nav-item-rss" target="_blank" href="?feed=rss"><i class="rtmicon-rss rtmicon-fw"></i>'. __('RSS','rtmedia').'</a>';
		return $options;
    }
