...
class RTMediaProUploadLimit {
	...
	function rtmedia_valid_type_check( $valid, $file ) {
		...
		if( apply_filters( 'rtmedia_pro_set_user_upload_limit', true ) ) {
	...
	function upload_limit_admin_setting() {
		...
		<div class="rt-table large-12">
			<div class="row rt-header">
				<div class="columns large-6 medium-6 small-6"><h4><?php _e( "Upload Limits Per User", "rtmedia" ) ?></h4></div>
				<div class="columns large-2 medium-2 small-2"><h4><?php _e( "Daily", "rtmedia" ); ?></h4></div>
				<div class="columns large-2 medium-2 small-2"><h4><?php _e( "Monthly", "rtmedia" ); ?></h4></div>
				<div class="columns large-2 medium-2 small-2"><h4><?php _e( "Lifetime", "rtmedia" ); ?></h4></div>
			</div>
			...
			foreach ( $render_groups as $key => $desc ) {
				...
				echo '<div class="columns large-6 medium-6 small-6">' . $desc . '</div>';
				echo '<div class="columns large-2 medium-2 small-2">';
