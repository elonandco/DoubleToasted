                                ...
                                <?php foreach ($bp_media_widget_query as $rt_media_gallery) { ?>
                                    ...
                                    <a href ="<?php echo get_rtmedia_permalink($rt_media_gallery->id); ?>" title="<?php echo $rt_media_gallery->media_title; ?>">
                                            <div class="rtmedia-item-thumbnail">
                                                <img src="<?php rtmedia_image("rt_media_thumbnail", $rt_media_gallery->id); ?>" alt="<?php echo $rt_media_gallery->media_title; ?>" style="max-height:<?php echo $thumbnail_height; ?>px;max-width:<?php echo $thumbnail_width ?>px;" >
                                            </div>
                                    </a>
