...
class RTMediaPro {
	...
	function rtm_db_upgrade_migrate_download_media_btn_settings(){
		if( ! rtmedia_get_site_option( 'rtmedia-migrate-download-btn-settings' ) ){
			...
			if( isset( $rtmedia ) && isset( $rtmedia->options ) ){
				...
				if( isset( $options['general_enableDownloads'] ) ){
					...
					$options[ 'allowedTypes_photo_download' ] = $val;
					$options[ 'allowedTypes_music_download' ] = $val;
					$options[ 'allowedTypes_video_download' ] = $val;
	...
	function enqueue_scripts_styles() {
        ...
        wp_localize_script( 'rtmedia-pro-main', 'rtmedia_favlist_delete_confirm', __('Are you sure you want to delete this Favlist?',"rtmedia"));
