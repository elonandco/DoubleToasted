...
function install_rtmedia_plugins( plugin_slug, action, rtm_nonce ) {
    ...
    jQuery( '.rtmedia-not-installed-error p' ).html( '<b>rtMedia</b> will be installed and activated. Please wait... <img src="' + rtmedia_pro_ajax_loader + '" />' );
...
function activate_rtmedia_plugins( path, action, rtm_nonce ) {
    jQuery( '.rtmedia-not-installed-error' ).removeClass( 'error' );
    jQuery( '.rtmedia-not-installed-error' ).addClass( 'updated' );
    jQuery( '.rtmedia-not-installed-error p' ).html( '<b>rtMedia</b> will be activated now. Please wait... <img src="' + rtmedia_pro_ajax_loader + '" />' );
