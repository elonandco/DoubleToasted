<div class="rtmedia-container">
	...
	<?php if ( have_rtmedia() ){ ?>
		<table class="rtmedia-list rtmedia-list-media rtmedia-list-document <?php echo rtmedia_media_gallery_class(); ?>">
			<thead>
				...
				<tr class="rtmedia-list-document-row" id="<?php echo rtmedia_id(); ?>">
					...
					<td>
						...
						if ( is_user_logged_in() && rtmedia_edit_allowed() ){
							?>
							<a href="<?php rtmedia_permalink(); ?>edit" class='no-popup' target='_blank' title='<?php _e( 'Edit this media', 'rtmedia' ); ?>'><i class='rtmicon-edit rtmicon-fw'></i></a>
						<?php
						}
						?>
					</td>
					<td>
						...
						if ( is_user_logged_in() && rtmedia_delete_allowed() ){
							?>
							<a href="#" class="no-popup rtmp-delete-media-document" title='<?php _e( 'Delete this media', 'rtmedia' ); ?>'><i class='rtmicon-trash-o rtmicon-fw'></i></a>
						<?php
						}
						?>
					</td>
