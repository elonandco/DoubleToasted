...
<?php if ( bp_has_members( 'type=alphabetical&include=' . bp_get_friendship_requests() ) ) : ?>
	...
	<div id="pag-top" class="pagination no-ajax large-12 columns" style="margin-left:0px;">
	...
	<div id="pag-bottom" class="pagination no-ajax large-12 columns">
...
<?php else: ?>
	...
	<div id="message" class="info large-12 columns">
