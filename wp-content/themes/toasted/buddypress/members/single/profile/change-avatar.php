...
<div class="hr-title hr-full hr-double" style="margin-top:10px;"><h3><?php _e( 'Change Avatar', 'buddypress' ); ?></h3></div>
...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
  ...
  <blockquote>
	...
	<form action="<?php echo bp_get_loggedin_user_link(); ?>profile/change-avatar#item-nav" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
      ...
      <div>
			<p id="avatar-upload">
				<input type="file" name="file" id="file" style="max-width:400px;" /><br />
				<input type="submit" name="upload" style="margin:0px;" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" />
