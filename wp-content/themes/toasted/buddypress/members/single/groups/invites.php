...
<?php if ( bp_has_groups( 'type=invites&user_id=' . bp_loggedin_user_id() ) ) : ?>
	...
	<ul id="group-list" class="invites item-list large-12 columns" role="main">
...
<?php else: ?>
	...
	<div id="message" class="info large-12 columns" role="main">
		<p><?php _e( 'No group invitations.', 'buddypress' ); ?></p>
	</div>
