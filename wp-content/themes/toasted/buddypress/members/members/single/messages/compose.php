<form action="<?php bp_messages_form_action('compose' ); ?>" method="post" id="send_message_form" class="large-12 columns standard-form" role="main" enctype="multipart/form-data">
