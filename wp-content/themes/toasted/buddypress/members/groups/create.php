...
<div id="buddypress">
	...
	<div id="item-header-content" class="large-12 medium-12 columns" <?php if (isset($_COOKIE['bp-profile-header']) && $_COOKIE['bp-profile-header'] == 'small') {echo 'style="display:none;"';} ?>>
		<h1 class="fl-left">Create a new Group</h1>
	</div>
	...
	<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
		...
		<div class="item-list-tabs no-ajax" id="group-create-tabs" role="navigation">
			<ul class="listless clear" id="cr-group-nav" >
...
<div class="large-12 columns create-group-details">
