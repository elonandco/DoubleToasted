...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<p class="activity-greeting"><?php if ( bp_is_group() )
		...
		printf( __( "What's toasty, %s?", 'buddypress' ), bp_get_user_firstname() );
	?></p>

	<div id="whats-new-content" class="">
		...
		<div id="whats-new-textarea">
			...
			<div id="whats-new-submit" class="fl-right">
				<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" class="dt-bp-button" value="<?php _e( 'Share', 'buddypress' ); ?>" />
			</div>
