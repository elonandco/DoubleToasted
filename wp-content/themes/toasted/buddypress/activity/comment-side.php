...
<?php do_action( 'bp_before_activity_comment' ); ?>
		...
		<li id="acomment-<?php bp_activity_comment_id(); ?>">
			...
			<?php	
				...
				// Used to set new comment ID in reply link
			...
			<div class="acomment-body">
				...
				<div class="accoment-meta clear">
					...
					<?php if ( is_user_logged_in() && $can_comment ) : ?>
						...
						<a href="#acomment-<?php bp_activity_comment_id(); ?>" class="single-acomment-reply bp-primary-action" id="acomment-reply-<?php bp_activity_id(); ?>-from-<?php echo $activities_template->activity->current_comment->id; ?>"><?php _e( 'Reply', 'buddypress' ); ?></a>
