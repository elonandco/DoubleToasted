<div class="item-list-tabs no-ajax profile-subn" id="subnav" role="navigation">
	<ul>
...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<p id="bp-group-check">
		<label>
			<input type="checkbox" id="group-notify-members" value="1" /> <?php _e( 'Notify group members of these changes via email', 'buddypress' ); ?>
		</label>
	</p>
...
<?php if ( bp_is_group_admin_screen( 'group-settings' ) ) : ?>
	...
	<div class="radio" id="dt-group-privacy-admin">
		<label>
	...
	<div class="radio" id="dt-group-invite-admin">
		<label>
...
<?php if ( bp_is_group_admin_screen( 'delete-group' ) ) : ?>
	...
	<h4>Permanently Delete Group</h4>

	<div id="message" class="info dt-delete-group">
