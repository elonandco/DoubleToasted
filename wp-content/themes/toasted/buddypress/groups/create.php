...
<div id="buddypress">
	...
	<div class="large-12 medium-12 columns" <?php if (isset($_COOKIE['bp-profile-header']) && $_COOKIE['bp-profile-header'] == 'small') {echo 'style="display:none;"';} ?>>
...
<div class="create-group-details">
