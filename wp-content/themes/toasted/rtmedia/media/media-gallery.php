<div class="rt-media-subnav fl-right" id="rtm-media-options">
...
<div class="rtmedia-container">
    ...
    <?php
        ...
        ?>
            <h3 id="rtmedia-header-title"><?php _e( 'Media Gallery', 'rtmedia' ); ?></h3>
        <?php }
        else { ?>
            <div id="rtm-gallery-title-container" class="row">
                ...
                <div id="rtm-media-options" class="columns large-5 small-12 medium-5"></div>
            </div>
			<div class="clear"></div>
