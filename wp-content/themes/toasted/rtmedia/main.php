    ...
    if ( ! $rt_ajax_request ) {
        ...
        if ( $template_type == 'buddypress' ) {
            ...
            if ( bp_displayed_user_id () ) {
                ...
                <div id="item-body" class="large-12 columns" style="clear:none;">

                    <?php do_action ( 'bp_before_member_body' ) ; ?>
                    <?php do_action ( 'bp_before_member_media' ) ; ?>
                    <div class="item-list-tabs no-ajax profile-subn fl-left" id="subnav">
                        <ul class="listless">
                    ...
                    if ( bp_has_groups () ) : while ( bp_groups () ) : bp_the_group () ;
                            ...
                            <div id="item-body"  class="large-10 medium-10 columns" style="clear:none;">

                                <?php do_action ( 'bp_before_group_body' ) ; ?>
                                <?php do_action ( 'bp_before_group_media' ) ; ?>
                                <div class="item-list-tabs profile-subn fl-left no-ajax" id="subnav">
                                    <ul class="listless">
