...
define('SWEETCAPTCHA_APP_ID', 238754); // your application id (change me)
define('SWEETCAPTCHA_KEY', '16bd693529bb6e52577ecee0c732be80'); // your application key (change me)
define('SWEETCAPTCHA_SECRET', 'be1fdb1ca3a7f951aa7e2bff11107197'); // your application secret (change me)
define('SWEETCAPTCHA_PUBLIC_URL', 'http://doubletoasted.com/wp-content/themes/toasted/modules/sweet/sweetcaptcha.php'); // public http url to this file
