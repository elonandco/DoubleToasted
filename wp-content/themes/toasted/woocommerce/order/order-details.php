					...
					<td class="product-name">
						<?php
							if ( $_product && ! $_product->is_visible() ) {
								...
								$orderURL = get_post_meta( $item['product_id'], '_lac0509_dt-product-url', true );
								echo apply_filters( 'woocommerce_order_item_name', sprintf( '<a href="' . $orderURL . '">%s</a>', $item['name'] ), $item );
							}
