...
<?php else : ?>
	...
	<p style="margin-bottom:30px;"><?php printf( __( '<a href="/membership/">Upgrade to our All Access membership plan</a> and gain full access to all Double Toasted content.</br>$6.99/month - First Week Free - Cancel Anytime', 'woocommerce-subscriptions' ), '<a href="' . get_permalink( woocommerce_get_page_id( 'shop' ) ) . '">', '</a>' ); ?></p>
